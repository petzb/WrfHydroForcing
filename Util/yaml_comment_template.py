...
'Input' : """#Input Example With Two Separate Inputs (a YAML list of input parameters)
#
#Input:
# - Forcing: RAP
#   Type: GRIB2
...
'Retrospective' : """#Retrospective Example:
#
# Retrospective:
#  Flag: False
...
'SuppForcing' : """# Example SuppForcing
#
#SuppForcing:
# - Pcp: MRMR_CONUS_MS
#   PcpTypes: GRIB2
